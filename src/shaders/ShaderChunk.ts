...
import instanced_sector_pars_vertex from "./chunks/instanced_sector_pars_vertex.glsl";
import instanced_sector_vertex from "./chunks/instanced_sector_vertex.glsl";
...
ShaderChunk["instanced_sector_pars_vertex"] = instanced_sector_pars_vertex;
ShaderChunk["instanced_sector_vertex"] = instanced_sector_vertex;
...
if (ShaderChunk["morphinstance_vertex"]) {
  ShaderChunk["morphinstance_vertex"] = ShaderChunk["morphinstance_vertex"].replaceAll(
    "gl_InstanceID",
    "instanceIndex",
  );
}
